...
%%%%%%%%%%% CASOS // POSIBILIDADES
%//////////// SOLITARIO
 if X5==1 && O1==1 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==0  
       writeDigitalPin(a,'D3',1);
       pause(1);
       writeDigitalPin(a,'D3',0);
       disp('1 = Cuadro 2 ');
       
elseif X5==1 && O1==0 && O2==1 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==0  
...
elseif X5==1 && O1==0 && O2==0 && O3==1 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==0 
       writeDigitalPin(a,'D3',1);
       pause(1);
       writeDigitalPin(a,'D3',0);
    disp('3 = Cuadro 2');
   
elseif X5==1 && O1==0 && O2==0 && O3==0 && O4==1 && O5==0 && O6==0 && O7==0 && O8==0 && O9==0 
      writeDigitalPin(a,'D3',1);
      pause(1);
      writeDigitalPin(a,'D3',0);
       disp('4 = Cuadro 2');
      
elseif X5==1 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==1 && O7==0 && O8==0 && O9==0 
       writeDigitalPin(a,'D2',1);
       pause(1);
       writeDigitalPin(a,'D2',0);
        disp('6 = Cuadro 1');
       
elseif X5==1 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==1 && O8==0 && O9==0 
       writeDigitalPin(a,'D2',1);
       pause(1);
       writeDigitalPin(a,'D2',0);
       disp('7 = Cuadro 1');
      
elseif X5==1 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==1 && O9==0 
       writeDigitalPin(a,'D2',1);
       pause(1);
       writeDigitalPin(a,'D2',0);
      disp('8 = Cuadro 1');
     
elseif X5==1 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==1
...
%/////////////////////// DECISIONES CON 2      
 elseif X2==1 && X5==1 && X4==0 && O1==1 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==1 && O9==0   
      writeDigitalPin(a,'D5',1);
%      pause(1);
%      writeDigitalPin(a,'D5',0);
     disp('1 y 8= Cuadro 4');
     
elseif X1==1 && X5==1&& O1==0 && O2==1 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==1  
     writeDigitalPin(a,'D8',1);
     pause(1);
     writeDigitalPin(a,'D8',0);
    disp('2 y 9 = Cuadro 7');
    
elseif X5==1 && X1==0 && O1==0 && O2==0 && O3==1 && O4==0 && O5==0 && O6==0 && O7==0 && O8==1 && O9==0   
     writeDigitalPin(a,'D2',1);
     pause(1);
     writeDigitalPin(a,'D2',0);
    disp('3 y 8 = Cuadro 1');
    
elseif X2==1 && X5==1  && O1==0 && O2==0 && O3==0 && O4==1 && O5==0 && O6==0 && O7==0 && O8==1 && O9==0   
     writeDigitalPin(a,'D8',1);
     pause(1);
     writeDigitalPin(a,'D8',0);
    disp('4 y 8 = Cuadro 7');
    
elseif  X1==1 && X5==1  && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==1 && O7==0 && O8==0 && O9==1   
    writeDigitalPin(a,'D4',1);
    pause(1);
    writeDigitalPin(a,'D4',0);
    disp('6 y 9 = Cuadro 3 ');
    
elseif  X5==1 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==1 && O8==0 && O9==1   
     writeDigitalPin(a,'D9',1);
     pause(1);
     writeDigitalPin(a,'D9',0);
    disp('7 y 9 = Cuadro 8');
    
elseif X5==1  && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==1 && O9==1   
    writeDigitalPin(a,'D8',1);
     pause(1);
     writeDigitalPin(a,'D8',0);
    disp('8 y 9= Cuadro 7');
    
elseif X1==0 && X5==1 && O1==0 && O2==1 && O3==0 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==1   
     writeDigitalPin(a,'D5',1);
     pause(1);
     writeDigitalPin(a,'D5',0);
    disp('9 y 2 = Cuadro 4');
...
%////////////////// DECISION CON 3 
elseif X2==1 && X4==1 && X5==1 && O1==1 && O2==0 && O3==0 && O4==0 && O5==0 && O6==1 && O7==0 && O8==1 && O9==0   
      writeDigitalPin(a,'D7',1);
      pause(1);
      writeDigitalPin(a,'D7',0);
     disp('1,8 y 6 = Cuadro 7');
     
elseif X1==1 && X4==0 && X5==1 && X7==1 && O1==0 && O2==1 && O3==1 && O4==0 && O5==0 && O6==0 && O7==0 && O8==0 && O9==1  
     writeDigitalPin(a,'D5',1);
     pause(1);
     writeDigitalPin(a,'D5',0);
    disp('2,9 y 3 = Cuadro 4 ');
    disp('ROBOT GANA');
    
elseif X3==0 && X5==1 && X8==0 && O1==0 && O2==1 && O3==0 && O4==1 && O5==0 && O6==0 && O7==0 && O8==0 && O9==1  
     writeDigitalPin(a,'D4',1);
     pause(1);
     writeDigitalPin(a,'D4',0);
    disp('2,9 y 4 = Cuadro 3');
    disp('ROBOT GANA');

    
elseif X1==1 && X2==1 && X5==1 && O1==0 && O2==0 && O3==1 && O4==0 && O5==0 && O6==0 && O7==0 && O8==1 && O9==1   
     writeDigitalPin(a,'D8',1);
     pause(1);
     writeDigitalPin(a,'D8',0);
    disp('3,8 y 9= Cuadro 7');
    
elseif X2==1 && X5==1&& X7==1 && O1==0 && O2==0 && O3==1 && O4==1 && O5==0 && O6==0 && O7==0 && O8==1 && O9==0   
     writeDigitalPin(a,'D10',1);
     pause(1);
     writeDigitalPin(a,'D10',0);
    disp('4,6 y 8 = Cuadro 9');
        
    
elseif  X1==1 && X2==0 && X3==1 && X4==0 && X5==1 && X7==0 && X8==0 && O1==0 && O2==0 && O3==0 && O4==0 && O5==0 && O6==1 && O7==1 && O8==0 && O9==1   
     writeDigitalPin(a,'D3',1);
     pause(1);
     writeDigitalPin(a,'D3',0);
    disp('6,9y 7  = Cuadro 2 ');
    disp('ROBOT GANA');
    
 
 elseif  X1==1 && X2==0 && X3==1 && X4==0 && X5==1 && X7==0 && X8==0 && O1==0 && O2==1 && O3==0 && O4==0 && O5==0 && O6==1 && O7==0 && O8==0 && O9==1   
     writeDigitalPin(a,'D8',1);
     pause(1);
    writeDigitalPin(a,'D8',0);
    disp('6,9y 2  = Cuadro 7 ');
    disp('ROBOT GANA');
    
    
    
elseif  X1==1 && X8==1 && X5==1 && O1==0 && O2==1 && O3==0 && O4==0 && O5==0 && O6==0 && O7==1 && O8==0 && O9==1   
     writeDigitalPin(a,'D7',1);
     pause(1);
     writeDigitalPin(a,'D7',0);
...
elseif X1==1 && X2==1 &&X5==1 && X7==1 && O1==0 && O2==0 && O3==1 && O4==0 && O5==0 && O6==1 && O7==0 && O8==1 && O9==1   
 ...
 elseif X1==1 && X2==1 &&X5==1 && X7==1 && O1==0 && O2==0 && O3==1 && O4==1 && O5==0 && O6==0 && O7==0 && O8==1 && O9==1   
      writeDigitalPin(a,'D7',1);
      pause(1);
      writeDigitalPin(a,'D7',0);
     disp('3,9,4 y 8 = Cuadro 6');
     disp('GATO!');
...
elseif X5==1 && X6==1 && O1==0 && O2==1 && O3==1 && O4==0 && O5==0 && O6==0 && O7==1 && O8==0 && O9==1   
     writeDigitalPin(a,'D5',1);
     pause(1);
     writeDigitalPin(a,'D5',0);
    disp('7,9,2 y 3 = Cuadro 4');
    disp('ROBOT GANA');
    
elseif X6==1 && X5==1 && O1==0 && O2==1 && O3==0 && O4==1 && O5==0 && O6==0 && O7==1 && O8==0 && O9==1   
     writeDigitalPin(a,'D4',1);
     pause(1);
     writeDigitalPin(a,'D4',0);
